"""
Django settings for cold_truth_41776 project.
...
ROOT_URLCONF = 'cold_truth_41776.urls'
...
WSGI_APPLICATION = 'cold_truth_41776.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_truth_41776 API",
    "DESCRIPTION": "API documentation for cold_truth_41776 App",
    "VERSION": "v1",
}
